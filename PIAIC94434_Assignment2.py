...
def function6():
    ...
    arr = np.zeros(10); arr[5]=10; arr[8]=20 #wrtie your code here
...
def function15():
    ...
    ans = np.sort(arr.view('i8,i8,i8'), order=['f1'], axis=0).view(np.int) #write your code here 
...
def function18():
    ...
    x = np.intersect1d(piaic, students) ; x=np. count_nonzero(x);# Write you code Here
    return x
